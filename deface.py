...
'''
  ...
  print ('\033[94m-'*50)
  print ''
  print ' \033[96m Author   : \033[95m S4K1B K1NG'
  print ''
  print ' \033[96m Tool     : \033[95m Deface Generator'
  print ''
  print' \033[96m Instagram : \033[95m https://www.instagram.com/s4k1bk1ng/'
  print ''
  print ' \033[96m Github   : \033[95m https://www.github.com/S4K1BK1NG/'
  print ''
  print ' \033[96m Coded By : \033[95m S4K1B H4CK3R'
  print ''
  print ('\033[94m-'*50)
  print ''
  print ''
...
bannar ()
# input
input2=raw_input('\033[92m Enter Your Code Name :\033[93m ') #code Name
input3=raw_input('\033[92m Enter Logo Link : \033[93m') # logo 
input4=raw_input('\033[92m Enter Your Team Name :\033[93m ') #Team name
part1='''<!doctype html>
<html lang="en">
  <head>
   <center> <p><font face="Jolly Lodger" color="red" size="5">'''
part2=input2+' Was Here !!!'
part33='''</p>
    <meta charset="utf-8">
...
part333=input2+'''</title>
  ...
  <body id="">
    <div class="tmp" id="">
    	<div class="container">
<center><h1><font face="Jolly Lodger" color="red" size="35">Hacked By <font color="red">'''
part3= part33+part333    
part4=input2
part5= '''<br></font></center>
    	<center>'''
    	
    	
part666='''<center><img src="'''
part66='''" height='275px' width='275px'></font></center><center>'''
part6=part666+input3+part66
part7='''</font></font>
<br>
...
<br>
<br>
<font face="Jolly Lodger" color="red" size="25">&#10026 TEAM &#10026;  <br><font face="Jolly Lodger" color="white" size="20">'''
part8=' &#9760 '+input4+ ' &#9760; '
#  all parts
part9='''</font></font>
 <div id="particles-js">
...
biva=open ('deface.html','w')
biva.write(parts)
biva.close()
os.system('mv deface.html /sdcard')
print ''
print ''
print 'Deface Page Generated... Check Your Internal storage'